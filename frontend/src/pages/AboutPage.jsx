  ...
  return (
    <div className="py-16 px-5 md:px-8 max-w-7xl mx-auto overflow-hidden">
      ...
      >
        ...
        <h1 className="font-serif text-4xl sm:text-5xl font-bold text-white">About Savannah Kitchen</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
        ...
        >
          ...
          <div className="absolute -bottom-6 -right-6 w-1/2 aspect-square rounded-2xl overflow-hidden border-4 border-[#12100e] shadow-2xl hidden sm:block">
            <img 
        ...
        <motion.div 
          ...
          className="space-y-6"
        >
          <h2 className="font-sans text-3xl font-bold text-white leading-snug">
          ...
          <div className="pt-2">
            ...
            <p className="text-xs uppercase tracking-widest text-stone-400">Head Executive Chef</p>
          </div>
        </motion.div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
        transition={{ duration: 0.7 }}
        className="grid grid-cols-2 lg:grid-cols-4 gap-6 bg-[#1a1714] border border-white/10 rounded-2xl p-8 text-center"
      >
        {stats.map((stat, idx) => {
